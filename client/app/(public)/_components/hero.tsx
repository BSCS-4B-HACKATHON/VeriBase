        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              >
                Verify <strong>ownership</strong> <span>&</span> <br />
                <strong>identity</strong> <em className="italic">on Base</em>
              </h1>
            </motion.div>
            ...
            >
              Securely verify your identity and property ownership through
              blockchain technology. Submit your National ID or Land Title for
              decentralized verification on Base.
            </motion.p>
