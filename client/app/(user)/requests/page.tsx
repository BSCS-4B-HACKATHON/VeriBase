...
import { getAllUsersMintRequests } from "@/lib/helpers";
...
export default function RequestsPage() {
  ...
  const filteredRequests = useMemo(() => {
    ...
    if (statusToMatch) {
      base = base.filter((req) => statusToMatch.includes(String(req.status)));
    }
      ...
      <div className="container mx-auto p-6 lg:p-8 space-y-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <Tabs
            ...
            className="w-full sm:w-auto bg-surface-200 rounded-md"
          >
            <TabsList className="grid w-full grid-cols-4 sm:w-auto bg-surface-75 rounded-md">
              <TabsTrigger
                value="all"
